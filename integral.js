const data = [
    { tipo: "500", cantidad: 15, latas: 0, picada: 2000, pesoindividual: 55.5 },
    { tipo: "1000", cantidad: 8, latas: 0, picada: 0, pesoindividual: 0 },
    
  ];

  const listaDeIngredientes = [
    { ingrediente: "harina", porcentaje: 0.55 },
    { ingrediente: "mogolla", porcentaje: 0.09 },
    { ingrediente: "azucar", porcentaje: 0.05 },
    { ingrediente: "sal", porcentaje: 0.01 },
    { ingrediente: "margarina", porcentaje: 0.05 },
    { ingrediente: "agua", porcentaje: 0.23 },
    { ingrediente: "levadura", porcentaje: 0.01 },
    { ingrediente: "gluten", porcentaje: 0.01 }
  ];
